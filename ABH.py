...
print(int(os.getenv("API_ID1")), os.getenv("API_HASH1"))
ABH1 = TelegramClient("code1", int(os.getenv("API_ID2")), os.getenv("API_HASH1")).start()
print(int(os.getenv("API_ID2")), os.getenv("API_HASH1"))
ABH2 = TelegramClient("code2", int(os.getenv("API_ID3")), os.getenv("API_HASH2")).start()
print(int(os.getenv("API_ID3")), os.getenv("API_HASH1"))
ABH3 = TelegramClient("code3", int(os.getenv("API_ID4")), os.getenv("API_HASH3")).start()
print(int(os.getenv("API_ID4")), os.getenv("API_HASH1"))
ABH4 = TelegramClient("code4", int(os.getenv("API_ID5")), os.getenv("API_HASH4")).start()
print(int(os.getenv("API_ID5")), os.getenv("API_HASH1"))
ABH5 = TelegramClient("code5", int(os.getenv("API_ID6")), os.getenv("API_HASH5")).start()
print(int(os.getenv("API_ID6")), os.getenv("API_HASH1"))
ABH6 = TelegramClient("code6", int(os.getenv("API_ID7")), os.getenv("API_HASH6")).start()
print(int(os.getenv("API_ID7")), os.getenv("API_HASH1"))
ABH7 = TelegramClient("code7", int(os.getenv("API_ID8")), os.getenv("API_HASH7")).start()
print(int(os.getenv("API_ID8")), os.getenv("API_HASH1"))
